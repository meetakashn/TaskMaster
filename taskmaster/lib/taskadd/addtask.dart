...
class _AddTaskState extends State<AddTask> {
                  ...
                  children: [
                    Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            color: Colors.yellow),
                        child: TextButton(
                          child: Text("Submit",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17,fontFamily: GoogleFonts.alata().fontFamily),),
                          onPressed: () async {
  ...
  Future<void> saveDataToDatabase() async {
    ...
    var result =await _userService.saveUser(_task);
    print(result);
  }
}
